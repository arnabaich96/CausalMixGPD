# ============================================================================
# Generate Precomputed Results for Cookbook Vignettes
# ============================================================================
#
# This script generates the .rds files needed by cookbook vignettes.
# Running this script exercises the causal, kernel, and S3 method code paths
# that contribute to package coverage.
#
# Usage:
#   source("tools/generate_cookbook_precomputed.R")
...
PRECOMP_DIR <- file.path("vignettes", "cookbook", "articles", "cookbook-precomputed")
...
generate_all_precomputed <- function(force = FALSE) {
  cat("============================================================\n")
  cat("Generating Precomputed Results for Cookbook Vignettes\n")
  cat("============================================================\n")
...
cat("Cookbook Vignette Precomputation Script loaded.\n\n")
cat("Usage:\n")
