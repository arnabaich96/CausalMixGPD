...
\begin{Schunk}
\begin{Sinput}
R> fit_clust <- dpmix.cluster(formula = medv ~ lstat + rm + nox, data = train_dat,
...
1 381.47 36.25 233.41 111.75         FALSE
\end{Soutput}
\end{Schunk}
...
\begin{Schunk}
\begin{Sinput}
R> cqte_fit <- cqte(fit, probs = c(0.25, 0.5, 0.75, 0.9, 0.95), newdata = xnew,
+                   interval = "credible")
