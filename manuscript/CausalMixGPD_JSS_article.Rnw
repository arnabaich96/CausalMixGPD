...
\usepackage{xurl}
\usepackage{enumitem}
\setlist[itemize]{itemsep=0.25ex,parsep=0.25ex,topsep=0.45ex,partopsep=0pt,leftmargin=*}
\usepackage[font=footnotesize,labelfont=bf,skip=1pt]{caption}
%% Tighter float spacing and more permissive float placement (layout only)
...
Carlo through \pkg{nimble}, and supports arm-specific outcome models
...
\sloppy
\raggedbottom
%% Slightly tighter JSS section vertical glue (layout only; same headings)
\setlength{\preXLskip}{1.2\baselineskip plus 0.35ex minus 0ex}
\setlength{\preLskip}{1.05\baselineskip plus 0.2ex minus 0ex}
\setlength{\preMskip}{0.68\baselineskip plus 0.12ex minus 0ex}
\setlength{\preSskip}{0.55\baselineskip plus 0.12ex minus 0ex}
\setlength{\postMskip}{0.3\baselineskip plus 0ex minus 0.1ex}
\setlength{\postSskip}{0.18\baselineskip plus 0ex minus 0.1ex}
\setlength{\parskip}{0.48ex plus 0.06ex minus 0.06ex}
\global\advance\textheight by 1\baselineskip
...
<<app_cluster_response_panels, echo=FALSE, message=FALSE, warning=FALSE, eval=TRUE, fig.width=10, fig.height=4.8, out.width='0.84\\linewidth', fig.pos='!htbp', fig.cap='Full-sample distribution of median house values (\\code{medv}, in thousands of US dollars) for the $506$ census tracts in the \\code{MASS::Boston} data set. Left panel: boxplot with upper outliers highlighted. Right panel: density-scaled histogram on the same variable.'>>=
...
<<app_cluster_overlay, echo=TRUE, message=FALSE, warning=FALSE, eval=TRUE, fig.width=8, fig.height=5.5, out.width='0.85\\linewidth', fig.pos='!htbp', fig.cap='Representative training-cluster summary for the Boston \\code{medv} analysis, returned by the \\code{plot()} method applied to the labels object from \\code{predict(fit_clust, type = "label")}. Training observations are shown on the response scale and coloured by their assigned cluster in the representative partition.'>>=
