...
ORCID: \href{https://orcid.org/0000-0003-4567-0027}{0000-0003-4567-0027}
}
...
Finally, Section~\ref{sec:software} provides details for
...
Version 0.7.0 of the \pkg{CausalMixGPD} R package is on CRAN
and can be installed using \code{install.packages("CausalMixGPD")}. The package is licensed under GPL-3.
The development version is available directly on GitHub
through the command

\code{remotes::install_github("arnabaich96/CausalMixGPD")}.
