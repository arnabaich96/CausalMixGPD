...
{\centering \includegraphics[width=0.80\linewidth]{figure/gpdDensityFigure-plot-1} 
...
{\centering \includegraphics[width=0.80\linewidth]{figure/splicedDensityFigure-plot-1} 
...
{\centering \includegraphics[width=0.80\linewidth]{figure/causalEstimandFigure-plot-1} 
...
\begin{Schunk}
\begin{Sinput}
R> predict(fit, newdata = x_new, y = y_grid, type = "survival", level = 0.95)
R> predict(fit, newdata = x_new, type = "quantile", index = c(0.5, 0.99),
+                             interval = "credible")
\end{Sinput}
\end{Schunk}
...
\begin{Schunk}
\begin{Sinput}
R> qtt_fit <- qtt(causal_fit, probs = c(0.5, 0.9, 0.95), interval = "credible")
R> summary(qtt_fit)
...
{\centering \includegraphics[width=0.86\linewidth]{figure/app_cluster_response_panels-1} 
...
\begin{Schunk}
\begin{Sinput}
R> fit_clust <- dpmix.cluster(formula = medv ~ ., data = train_dat,
...
{\centering \includegraphics[width=0.84\linewidth]{figure/app_cluster_psm_plot-code-1} 
...
{\centering \includegraphics[width=0.84\linewidth]{figure/app_cluster_overlay-1} 
...
{\centering \includegraphics[width=0.80\linewidth]{figure/app_cluster_test_sizes-1} 
...
+  }
R> app_lalonde_x_formula <- ~age_z + educ_z + race + married + nodegree + re74_z +
+      re75_z
...
{\centering \includegraphics[width=0.88\linewidth]{figure/app_lalonde_response_panels-1} 
...
1 417.19 13.95 213.39 189.82         FALSE
\end{Soutput}
\end{Schunk}
...
\begin{Schunk}
\begin{Sinput}
R> qte_fit <- qte(fit, probs = c(0.25, 0.5, 0.75), interval = "credible")
\end{Sinput}
\end{Schunk}
...
{\centering \includegraphics[width=0.88\linewidth]{figure/qte_plot-1} 
...
{\centering \includegraphics[width=0.76\linewidth]{figure/cate_plot-1} 
...
1  Profile 1  1  0.25  -2.521841198   -7.744296  4.0271372
2  Profile 1  1  0.50  -3.717253897   -7.385001 -0.6244419
3  Profile 1  1  0.75  -3.036742586   -7.347654  1.4575352
4  Profile 1  1  0.90  -1.616077528   -7.876948  5.9154540
5  Profile 1  1  0.95  -0.002597363   -8.645220 10.5596639
6  Profile 2  2  0.25  -1.388753348   -8.374172  3.5607329
7  Profile 2  2  0.50  -4.461346476   -9.850380 -0.1311481
8  Profile 2  2  0.75  -4.406719223  -10.769044  0.5638009
9  Profile 2  2  0.90  -3.966523104  -11.325236  3.6031938
10 Profile 2  2  0.95  -3.546162922  -13.181625  6.9877301
11 Profile 3  3  0.25  -1.400116612   -6.699770  2.7939363
12 Profile 3  3  0.50  -1.800035981   -7.721600  3.5216058
13 Profile 3  3  0.75  -2.604699710   -8.484734  4.2098620
14 Profile 3  3  0.90  -2.871274028   -8.828207  4.2015030
15 Profile 3  3  0.95  -2.528672343  -10.414719  8.3735820
16 Profile 4  4  0.25  -2.553434640   -9.052905  4.3991099
17 Profile 4  4  0.50  -5.901260763  -17.654505  6.3991686
18 Profile 4  4  0.75 -11.486181749  -45.838709 20.1632763
19 Profile 4  4  0.90 -19.094601788  -86.637680 42.1730175
20 Profile 4  4  0.95 -24.260813769 -119.477696 64.8149038
\end{Soutput}
\end{Schunk}
