---
title: "Advanced: GPD-in-DPM (CRP-only)"
...
# Data (positive outcomes shown here)
y <- your_numeric_vector
N <- length(y)
...
# Tail settings (example; choose to be fixed or model them)
threshold  <- quantile(y, 0.90)
tail_scale <- 1.0
tail_shape <- 0.1
...
samps <- runMCMC(cmcmc, niter = 2000, nburnin = 1000, thin = 1, setSeed = 1)
```
