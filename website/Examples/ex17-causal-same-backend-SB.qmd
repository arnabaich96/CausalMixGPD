---
title: "ex17. Causal Inference: Same Backend (SB) - Laplace Kernel"
---
...
- Previous: [ex16-causal-same-backend-CRP](ex16-causal-same-backend-CRP.html)
- Next: [ex18-causal-different-backends-CRP](ex18-causal-different-backends-CRP.html)
