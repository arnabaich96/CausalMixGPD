---
title: "ex16. Causal Inference: Mixed Backends (CRP+SB) - Cauchy/Laplace"
---
...
- Previous: [ex15-causal-x-no-ps-SB](ex15-causal-x-no-ps-SB.html)
- Next: [ex17-causal-same-backend-SB](ex17-causal-same-backend-SB.html)
