---
title: "ex05. Unconditional DPmix (CRP Backend)"
output:
  html_document:
    toc: true
    toc_depth: 3
...
fit_crp <- load_or_fit("ex05-unconditional-DPmix-CRP-fit_crp", run_mcmc_bundle_manual(bundle_crp))
```
...
- Previous: [backends-and-workflow](../QuickStart/backends-and-workflow.html)
- Next: [ex06-unconditional-DPmix-CRP](ex06-unconditional-DPmix-CRP.html)
