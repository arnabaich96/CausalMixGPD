---
title: "ex12. Conditional DPmixGPD with CRP Backend"
---
...
**Purpose**: Combine conditional modeling with GPD tail augmentation so each covariate slice inherits both mixture bulk and tail behavior. This extends the unconditional GPD (ex06) and conditional DP (ex08).
...
fit_cond_gpd_lognormal <- load_or_fit("ex12-conditional-DPmixGPD-CRP-fit_cond_gpd_lognormal", run_mcmc_bundle_manual(bundle_cond_gpd_lognormal))
fit_cond_gpd_normal <- load_or_fit("ex12-conditional-DPmixGPD-CRP-fit_cond_gpd_normal", run_mcmc_bundle_manual(bundle_cond_gpd_normal))
...
- Next: Mirror this workflow with the SB backend in `ex11`.
...
- Previous: [ex11-conditional-DPmix-SB](ex11-conditional-DPmix-SB.html)
- Next: [ex13-conditional-DPmixGPD-SB](ex13-conditional-DPmixGPD-SB.html)
