...
> For the underlying “where each option lives” map (core customization surface + extension points), see [Theory: Customization maps + extension points](theory/06-customization-and-extensions.qmd).
...
## Interpretation
- Canonical concept page: [Customization And Tuning](customization-and-tuning.qmd)
