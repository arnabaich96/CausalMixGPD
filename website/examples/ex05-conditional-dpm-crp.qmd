...
fit_cond_normal <- load_or_fit("ex05-conditional-dpm-crp-fit_cond_normal", mcmc(bundle_cond_normal))
fit_cond_amoroso <- load_or_fit("ex05-conditional-dpm-crp-fit_cond_amoroso", mcmc(bundle_cond_amoroso))
