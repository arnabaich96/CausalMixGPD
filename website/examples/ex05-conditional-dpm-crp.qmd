...
fit_cond_normal <- load_or_fit("ex05-conditional-dpm-crp-fit_cond_normal", run_mcmc_bundle_manual(bundle_cond_normal))
fit_cond_amoroso <- load_or_fit("ex05-conditional-dpm-crp-fit_cond_amoroso", run_mcmc_bundle_manual(bundle_cond_amoroso))
