...
fit_sb_gamma <- load_or_fit("ex02-unconditional-dpm-sb-fit_sb_gamma", run_mcmc_bundle_manual(bundle_sb_gamma))
fit_sb_cauchy <- load_or_fit("ex02-unconditional-dpm-sb-fit_sb_cauchy", run_mcmc_bundle_manual(bundle_sb_cauchy))
```
...
fit_crp_small <- load_or_fit("ex02-unconditional-dpm-sb-fit_crp_small", run_mcmc_bundle_manual(bundle_crp_small))
