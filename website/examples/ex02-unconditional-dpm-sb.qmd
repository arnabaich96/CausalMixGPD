...
fit_sb_gamma <- load_or_fit("ex02-unconditional-dpm-sb-fit_sb_gamma", mcmc(bundle_sb_gamma))
fit_sb_cauchy <- load_or_fit("ex02-unconditional-dpm-sb-fit_sb_cauchy", mcmc(bundle_sb_cauchy))
```
...
fit_crp_small <- load_or_fit("ex02-unconditional-dpm-sb-fit_crp_small", mcmc(bundle_crp_small))
