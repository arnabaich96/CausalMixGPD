...
```{r data-setup}
data("nc_posX100_p5_k4", package = "CausalMixGPD")
...
fit_cond_gpd_lognormal <- load_or_fit("ex07-conditional-dpmgpd-crp-fit_cond_gpd_lognormal", mcmc(bundle_cond_gpd_lognormal))
fit_cond_gpd_normal <- load_or_fit("ex07-conditional-dpmgpd-crp-fit_cond_gpd_normal", mcmc(bundle_cond_gpd_normal))
