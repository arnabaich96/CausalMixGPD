...
fit_sb_gpd <- load_or_fit("ex04-unconditional-dpmgpd-sb-fit_sb_gpd", mcmc(bundle_sb_gpd))
summary(fit_sb_gpd)
```
...
fit_sb_bulk <- load_or_fit("ex04-unconditional-dpmgpd-sb-fit_sb_bulk", mcmc(bundle_sb_bulk))
