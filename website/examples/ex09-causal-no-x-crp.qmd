...
# CRP + GPD in this no-X example can stall under arm-parallel execution on some Windows setups.
causal_run_mcmc_gpd <- list(show_progress = FALSE, parallel_arms = FALSE, workers = 1L, timing = TRUE)
...
predict_workers_ex09 <- if (isTRUE(FAST)) 1L else max_workers
