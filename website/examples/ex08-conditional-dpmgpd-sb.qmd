...
```{r mcmc, cache=TRUE}
fit_sb_cond_gpd_gamma <- load_or_fit("ex08-conditional-dpmgpd-sb-fit_sb_cond_gpd_gamma", run_mcmc_bundle_manual(bundle_sb_cond_gpd_gamma))
fit_sb_cond_gpd_laplace <- load_or_fit("ex08-conditional-dpmgpd-sb-fit_sb_cond_gpd_laplace", run_mcmc_bundle_manual(bundle_sb_cond_gpd_laplace))
