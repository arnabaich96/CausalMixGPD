...
```{r mcmc, cache=TRUE}
fit_sb_cond_gpd_gamma <- load_or_fit("ex08-conditional-dpmgpd-sb-fit_sb_cond_gpd_gamma", mcmc(bundle_sb_cond_gpd_gamma))
fit_sb_cond_gpd_laplace <- load_or_fit("ex08-conditional-dpmgpd-sb-fit_sb_cond_gpd_laplace", mcmc(bundle_sb_cond_gpd_laplace))
