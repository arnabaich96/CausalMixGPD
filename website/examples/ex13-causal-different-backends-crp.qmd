...
```{r ate-crp-sb}
ate_crp_sb <- cate(fit_crp_sb, newdata = x_eval,
                  interval = "credible", nsim_mean = 100)
safe_plot(ate_crp_sb)
```

```{r qte-crp-sb}
qte_crp_sb <- cqte(fit_crp_sb, probs = c(0.25, 0.5, 0.75),
