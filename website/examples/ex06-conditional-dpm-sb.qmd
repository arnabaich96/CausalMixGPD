...
```{r mcmc, cache=TRUE}
fit_sb_normal <- load_or_fit("ex06-conditional-dpm-sb-fit_sb_normal", mcmc(bundle_sb_normal))
fit_sb_cauchy <- load_or_fit("ex06-conditional-dpm-sb-fit_sb_cauchy", mcmc(bundle_sb_cauchy))
