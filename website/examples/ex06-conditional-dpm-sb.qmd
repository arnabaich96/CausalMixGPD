...
```{r mcmc, cache=TRUE}
fit_sb_normal <- load_or_fit("ex06-conditional-dpm-sb-fit_sb_normal", run_mcmc_bundle_manual(bundle_sb_normal))
fit_sb_cauchy <- load_or_fit("ex06-conditional-dpm-sb-fit_sb_cauchy", run_mcmc_bundle_manual(bundle_sb_cauchy))
