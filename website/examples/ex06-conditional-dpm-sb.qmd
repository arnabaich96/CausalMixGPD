...
pred_q_normal <- predict(fit_sb_normal, x = as.matrix(X_eval), type = "quantile", p = quant_probs)
pred_q_cauchy <- predict(fit_sb_cauchy, x = as.matrix(X_eval), type = "quantile", p = quant_probs)
