...
This mirrors the direct `DPmixGPD::build_nimble_bundle()` workflow in `v04`, but with **tail augmentation** turned on (`GPD = TRUE`). Here we use an **Inverse Gaussian** bulk kernel and estimate the GPD threshold with a lognormal prior centered at the empirical 80th percentile.
...
- Previous: [v07-unconditional-DPmix-SB](v07-unconditional-DPmix-SB.html)
- Next: [v09-unconditional-DPmixGPD-SB](v09-unconditional-DPmixGPD-SB.html)
