...
# --- Gamma kernel ---
bundle_sb_gamma <- DPmixGPD::build_nimble_bundle(
  y = y_mixed,
  kernel = "gamma",
  backend = "sb",
...
# --- Cauchy kernel ---
bundle_sb_cauchy <- DPmixGPD::build_nimble_bundle(
  y = y_mixed,
  kernel = "cauchy",
  backend = "sb",
  components = 5,
...
safe_plot(fit_sb_gamma, family = c("traceplot", "autocorrelation", "running"))
...
bundle_crp_small <- DPmixGPD::build_nimble_bundle(
  y = y_mixed,
  kernel = "gamma",
  backend = "crp",
  components = 5,
...
- Previous: [v06-unconditional-DPmix-CRP](v06-unconditional-DPmix-CRP.html)
- Next: [v08-unconditional-DPmixGPD-CRP](v08-unconditional-DPmixGPD-CRP.html)
