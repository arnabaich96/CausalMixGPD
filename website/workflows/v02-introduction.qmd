---
title: "2. Introduction to DPmixGPD"
output:
  rmarkdown::html_vignette:
    highlight: null
    code_folding: show
vignette: >
  %\VignetteIndexEntry{2. Introduction to DPmixGPD}
...
```{r intro-quickstart, cache=FALSE}
...
- Previous: [v01-start-here](v01-start-here.html)
- Next: [v03-basic-model-compile-run](v03-basic-model-compile-run.html)
