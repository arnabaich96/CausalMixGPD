...
sequenceDiagram
  ...
  participant B as build_nimble_bundle()
  participant M as run_mcmc_bundle_manual()
  participant F as mixgpd_fit
  U->>B: build_nimble_bundle(...)
  B->>S: compile spec
...
sequenceDiagram
  participant U as User
  participant C as build_causal_bundle()
  participant P as PS sub-bundle
  participant M as run_mcmc_causal()
  participant Q as qte()/ate()
  U->>C: build_causal_bundle(...)
