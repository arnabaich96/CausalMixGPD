...
```
    ...
    Summary table
      parameter  mean    sd q0.025 q0.500 q0.975     ess
     weights[1] 0.544 0.074  0.408  0.540  0.681  20.835
     weights[2] 0.358 0.077  0.187  0.370  0.480  22.198
          alpha 0.607 0.389  0.134  0.519  1.590 104.174
       shape[1] 2.091 0.573  1.344  2.135  3.367  14.987
       shape[2] 2.805 0.895  1.179  2.992  4.062  11.818
       scale[1] 0.583 0.298  0.280  0.430  1.170  19.365
       scale[2] 1.032 0.644  0.304  0.844  2.226   4.070
