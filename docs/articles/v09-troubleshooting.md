...
This note collects quick sanity checks to run when a bundle refuses to
compile, posterior draws look odd, or predictions fail.
...
truncation.](v09-troubleshooting_files/figure-html/trouble-viz-weights-1.png)
