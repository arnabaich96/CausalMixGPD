...
| meta | components | info | model | 5 |  |  |
| meta | N | info | model | 32 |  |  |
| meta | P | info | model | 2 |  |  |
| concentration | alpha | dist | scalar | gamma(shape=1, rate=1) |  | stochastic concentration |
| bulk | loc | link | regression | beta_loc ~ normal(mean=0, sd=2) | identity | beta_loc is 5 x 2 (components x P) |
| bulk | scale | link | regression | beta_scale ~ normal(mean=0, sd=2) | identity | beta_scale is 5 x 2 (components x P) |
| bulk | shape1 | fixed | component (1:5) | 1 |  |  |
| bulk | shape2 | dist | component (1:5) | gamma(shape=2, rate=1) |  | iid across components |
| gpd | threshold | link | observation (1:N) | beta_threshold ~ normal(mean=0, sd=0.2) | exp | beta_threshold is length P=2 |
| gpd | tail_scale | link | observation (1:N) | beta_tail_scale ~ normal(mean=0, sd=0.5) | exp | beta_tail_scale is length P=2; tail_scale\[i\] deterministic |
| gpd | tail_shape | dist | scalar | normal(mean=0, sd=0.2) |  |  |

Monitors n = 11 alpha, w\[1:5\], z\[1:32\], beta_loc\[1:5,1:2\],
beta_scale\[1:5,1:2\], shape1\[1:5\], shape2\[1:5\], threshold\[1:32\],
beta_threshold\[1:2\], beta_tail_scale\[1:2\], tail_shape
...
WAIC: 289.883 lppd: -143.126 \| pWAIC: 1.816
...
2  2    13.79  4.30  36.3
3  3     7.84  2.33  26.3
4  4    19.90 10.36  47.5
5  5    21.56 -1.74  57.9
6  6    26.23  7.56  53.0
head(pred_q90$fit)
  estimate index id lower upper
1     30.9   0.9  1  24.9  48.6
2     39.3   0.9  2  30.0  61.0
3     23.9   0.9  3  19.8  37.7
4     54.0   0.9  4  37.1  84.0
5     63.7   0.9  5  43.4 104.6
6     68.0   0.9  6  43.0 107.6
```
...
1 10.22 2.260  31.0     10.78
2 13.89 1.739  38.4      7.11
3  7.74 0.824  25.6     15.06
4 19.91 7.919  43.5      1.49
5 21.43 5.082  58.6     -2.73
6 25.64 6.697  58.1     -7.54
summary(fvals$residuals)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
-152.23  -10.41   -0.62  -10.51   10.88   29.28 
```

``` r
raw_resid <- residuals(fit_amoroso, type = "raw")
head(raw_resid)
[1] 10.78  7.11 15.06  1.49 -2.73 -7.54
```
...
Mazda RX4         0.510    0.856 -13.420  17.8
Mazda RX4 Wag     0.367    2.057 -22.109  23.9
Datsun 710        0.667    3.818 -10.417  16.0
Hornet 4 Drive    0.253    3.560  -0.642  17.9
Hornet Sportabout 0.270   -5.668 -24.992  32.3
Valiant           0.162    3.824 -12.026  27.8
```
...
| id  | estimate |  lower   |  upper  |
|:---:|:--------:|:--------:|:-------:|
|  1  |  3.025   | -214.666 | 277.54  |
|  2  |  2.837   | -226.896 | 271.073 |
|  3  |   2.65   | -178.65  | 227.58  |
|  4  |  4.576   | -202.892 | 262.122 |
|  5  |  -3.944  | -317.567 | 407.054 |
|  6  |   4.34   | -199.598 | 241.31  |
...
ATE statistics: Mean: -2.351 \| Median: -0.867 Range: \[-29.153, 9.448\]
SD: 9.802

Credible interval width: Mean: 640.457 \| Median: 558.11 Range:
\[242.755, 1413.862\]
