...
```
    ...
    $diagnostics
    $diagnostics$n_draws_total
    [1] 220

    $diagnostics$n_draws_valid
    [1] 220

    $diagnostics$n_draws_dropped
    [1] 0

    $diagnostics$nsim_mean
    [1] 150
...
```
    ...
    1  0.25  1    -0.47 -2.93  2.32
    2  0.50  1    -1.14 -4.81  2.71
    3  0.75  1    -1.90 -7.04  2.83
...
```
    ...
    -- Outcome fits --
    [control]
    MixGPD fit | backend: Chinese Restaurant Process | kernel: Gamma Distribution | GPD tail: TRUE
    n = 232 | components = 6 | epsilon = 0.025
    MCMC: niter=300, nburnin=80, thin=1, nchains=1 
    Fit
    Use summary() for posterior summaries; plot() for diagnostics; predict() for predictions.
...
```
          ...
          y ps trt_estimate trt_lower trt_upper con_estimate con_lower con_upper
    1 0.900 NA            1     0.437    0.5024            1    0.3556     0.437
    2 1.352 NA            1     0.348    0.4006            1    0.2292     0.399
    3 1.148 NA            1     0.394    0.4488            1    0.2894     0.421
    4 1.932 NA            1     0.207    0.2862            1    0.1193     0.379
    5 3.344 NA            1     0.049    0.0813            1    0.0145     0.088
    6 0.949 NA            1     0.430    0.4928            1    0.3430     0.426
...
```
          ...
          y ps trt_estimate trt_lower trt_upper con_estimate con_lower con_upper
    1 0.900 NA            1    0.5911     0.689            1   0.34148    0.7610
    2 1.352 NA            1    0.4056     0.502            1   0.20593    0.5966
    3 1.148 NA            1    0.4825     0.582            1   0.25864    0.6695
    4 1.932 NA            1    0.2268     0.309            1   0.10830    0.4148
    5 3.344 NA            1    0.0547     0.106            1   0.00904    0.0588
    6 0.949 NA            1    0.5680     0.666            1   0.32305    0.7427
...
```
    ...
    $qte$fit
      index id  estimate  lower upper
    1  0.25  1  0.154690 -0.257 0.411
    2  0.50  1  0.111256 -0.449 0.574
    3  0.75  1 -0.000813 -0.546 0.742
