# 6. Unconditional DPmixGPD with CRP Backend
...
![](v06-unconditional-DPmixGPD-CRP_files/figure-html/data-setup-1.png)
...
![](v06-unconditional-DPmixGPD-CRP_files/figure-html/threshold-selection-1.png)
...
WAIC: 667.922
lppd: -304.402 | pWAIC: 29.559

Summary table
  parameter  mean    sd q0.025 q0.500 q0.975    ess
 weights[1] 0.672 0.193  0.404  0.597  1.000  3.339
      alpha 0.587 0.392  0.015  0.534  1.488 43.486
 tail_scale 1.925 0.286  1.455  1.882  2.462 20.657
 tail_shape 0.131 0.071  0.020  0.108  0.275 11.529
  threshold 2.993 0.945  1.609  2.977  5.155  8.172
    mean[1] 2.293 0.579  1.317  2.342  3.165  7.292
   shape[1] 3.352 0.980  2.135  3.046  6.318 15.474
```
...
![](v06-unconditional-DPmixGPD-CRP_files/figure-html/fit-plots-1.png)

    === density ===

![](v06-unconditional-DPmixGPD-CRP_files/figure-html/fit-plots-2.png)

    === running ===

![](v06-unconditional-DPmixGPD-CRP_files/figure-html/fit-plots-3.png)
...
![](v06-unconditional-DPmixGPD-CRP_files/figure-html/fit-plots-4.png)

    === autocorrelation ===

![](v06-unconditional-DPmixGPD-CRP_files/figure-html/fit-plots-5.png)

    === geweke ===

![](v06-unconditional-DPmixGPD-CRP_files/figure-html/fit-plots-6.png)
...
visualize densities, survival curves, and quantiles.
...
![](v06-unconditional-DPmixGPD-CRP_files/figure-html/density-predict-1.png)
...
![](v06-unconditional-DPmixGPD-CRP_files/figure-html/survival-predict-1.png)
...
![](v06-unconditional-DPmixGPD-CRP_files/figure-html/quantile-predict-1.png)
...
compare_tbl %>%
  ...
  kable(caption = "Posterior Quantiles for Bulk-Only vs GPD Models", align = "c") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = FALSE, position = "center")
```

|   model    | index | estimate | lower  |   upper    |
|:----------:|:-----:|:--------:|:------:|:----------:|
| Bulk only  | 0.90  |  26.918  | 10.964 |  1558.615  |
| Bulk only  | 0.95  |  55.779  | 18.620 | 12469.172  |
| Bulk only  | 0.99  | 223.187  | 50.080 | 603965.535 |
| Bulk + GPD | 0.90  |  4.757   | 3.276  |   5.784    |
| Bulk + GPD | 0.95  |  6.260   | 4.719  |   7.650    |
| Bulk + GPD | 0.99  |  10.246  | 8.375  |   13.939   |

Posterior Quantiles for Bulk-Only vs GPD Models

``` r
plot(bulk_quantiles)
```

![](v06-unconditional-DPmixGPD-CRP_files/figure-html/quantile-plot-1.png)

``` r
plot(tail_quantiles)
```

![](v06-unconditional-DPmixGPD-CRP_files/figure-html/quantile-plot-2.png)
...
|:-----:|:--------:|:-----:|:------:|
| 0.995 |  12.342  | 9.688 | 17.636 |
| 0.990 |  10.246  | 8.375 | 13.939 |
| 0.975 |  8.012   | 6.232 | 10.018 |
...
![](v06-unconditional-DPmixGPD-CRP_files/figure-html/residuals-1.png)![](v06-unconditional-DPmixGPD-CRP_files/figure-html/residuals-2.png)
...
|:---------:|:------:|:--------:|:--------:|
|   2.652   | 10.776 |  4.972   |  16.322  |
|   3.044   | 10.982 |  4.137   |  17.048  |
|   3.507   | 10.661 |  7.115   |  15.780  |
|   3.938   | 10.679 |  8.123   |  15.017  |
|   4.597   | 11.168 |  8.375   |  16.098  |
