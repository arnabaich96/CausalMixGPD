...
- [14. Causal Inference: Different Backends per Arm
  (Bulk-only)](https://example.com/DPmixGPD/articles/v14-causal-different-backends-CRP.md):
- [15. Causal Inference: Different Backends per Arm (GPD
  Augmentation)](https://example.com/DPmixGPD/articles/v15-causal-different-backends-SB.md):
