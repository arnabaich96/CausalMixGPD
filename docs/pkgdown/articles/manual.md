...
- [**Available
  Distributions**](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/distributions.md) -
  Overview of supported mixture kernels (Normal, Lognormal, Gamma, etc.)
  and their properties

- [**Model
  Specification**](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/model-spec.md) -
  How to specify models, set priors, and configure parameters

- [**MCMC
  Workflow**](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/mcmc-workflow.md) -
  Running MCMC chains, convergence diagnostics, and best practices

#### Model types

- [**Unconditional
  Models**](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/unconditional.md) -
  Density estimation without covariates for univariate data

- [**Conditional
  Models**](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/conditional.md) -
  Covariate-dependent density estimation using parameter linking

- [**Causal
  Inference**](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/causal.md) -
...
- [**Backends (CRP vs
  SB)**](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/backends.md) -
  Comparing Chinese Restaurant Process and Stick-Breaking inference
  approaches

- [**S3 Methods
  Reference**](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/reference-s3.md) -
...
3.  **What to cook**: Jump to
    [Unconditional](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/unconditional.md),
    [Conditional](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/conditional.md),
    or
    [Causal](https://arnabaich96.github.io/DPmixGPD/pkgdown/articles/causal.md)
    as needed
