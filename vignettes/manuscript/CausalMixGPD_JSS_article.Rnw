...
<<overview-mcmc-settings, echo=TRUE, eval=TRUE, results='hide'>>=
mcmc_fixed <- list(
  niter = 200,
  nburnin = 50,
  thin = 1,
...
<<overview-fit-model-cache, echo=FALSE, eval=TRUE, include=FALSE>>=
fit <- read_cache_rds("fits", "overview_fit.rds")
@

<<overview-fit-model-results, echo=FALSE, eval=TRUE>>=
print_wrapped(fit)
@
...
<<overview-mcmc-diagnostics-cache, echo=FALSE, eval=TRUE, include=FALSE>>=
overview_mcmc <- read_cache_rds("tables", "overview_mcmc.rds")
p_hat <- overview_mcmc$p_hat
@

<<overview-mcmc-diagnostics-results, echo=FALSE, eval=TRUE>>=
print_wrapped(fit)
p_hat
@
...
<<overview-estimation-same-fit-cache, echo=FALSE, eval=TRUE, include=FALSE>>=
overview_est <- read_cache_rds("tables", "overview_estimation_same_fit.rds")
est_quant <- overview_est$est_quant
@

<<overview-estimation-same-fit-results, echo=FALSE, eval=TRUE>>=
...
<<overview-predict-cache, echo=FALSE, eval=TRUE, include=FALSE>>=
...
<<overview-predict-grid-results, echo=FALSE, eval=TRUE>>=
x_new
head(y_grid, 4)
p_grid
@

<<overview-predict-density-results, echo=FALSE, eval=TRUE>>=
head(as.data.frame(pdens$fit), 4)
@

<<overview-predict-survival-results, echo=FALSE, eval=TRUE>>=
head(as.data.frame(psurv$fit), 4)
@

<<overview-predict-quantile-results, echo=FALSE, eval=TRUE>>=
