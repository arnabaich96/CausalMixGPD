...
output: 
  rmarkdown::html_vignette:
    code_folding: show
vignette: >
  %\VignetteIndexEntry{11. Conditional DPmixGPD with Stick-Breaking Backend}
...
```{r diagnostics}
plot(fit_sb_cond_gpd_gamma, family = c("traceplot", "density"))
plot(fit_sb_cond_gpd_laplace, family = c("traceplot", "density"))
```
