...
We use the **S3 `predict()` objects** and their dedicated `if (interactive()) plot()` methods to visualize densities, survival curves, and posterior-mean quantiles (i.e., averages of q(p | θ) over draws).
