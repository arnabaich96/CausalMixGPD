---
title: "Workflow 8: Unconditional DPmixGPD with CRP Backend"
output: 
  rmarkdown::html_vignette:
    code_folding: show
vignette: >
  %\\VignetteIndexEntry{Workflow 8: Unconditional DPmixGPD with CRP Backend}
...
The bulk density is modeled with a DP mixture, while a GPD tail is spliced
above a threshold $u$ to stabilize tail inference. The CRP backend governs
cluster allocations in the bulk.
