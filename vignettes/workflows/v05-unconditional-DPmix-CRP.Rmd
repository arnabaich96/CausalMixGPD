---
title: "Workflow 5: Unconditional DPmix (CRP Backend)"
output:
  html_document:
    toc: true
    toc_depth: 3
    ...
    highlight: tango
vignette: >
  %\\VignetteIndexEntry{Workflow 5: Unconditional DPmix (CRP Backend)}
...
$f(y)=\\int K(y;\\theta)\\,dG(\\theta)$ with $G \\sim \\mathrm{DP}(\\alpha, G_0)$.
The CRP backend implements this using cluster allocations.
