---
title: "Workflow 18: Causal Inference: Mixed Backends (Bulk-only) - Cauchy Kernel"
output:
  rmarkdown::html_vignette:
    code_folding: show
vignette: >
  %\\VignetteIndexEntry{Workflow 18: Causal Inference: Mixed Backends (Bulk-only) - Cauchy Kernel}
...
Mixed-backend causal models allow each treatment arm to use a different DP
mixture representation. This can improve fit when treated and control groups
exhibit distinct distributional complexity.
