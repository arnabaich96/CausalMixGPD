---
title: "Workflow 1: Introduction to DPmixGPD"
output: 
  rmarkdown::html_vignette:
    code_folding: show
vignette: >
  %\\VignetteIndexEntry{Workflow 1: Introduction to DPmixGPD}
...
DP mixtures represent densities as $f(y)=\\int K(y;\\theta)\\,dG(\\theta)$ with
$G \\sim \\mathrm{DP}(\\alpha, G_0)$. Optional GPD splicing replaces the tail
beyond a threshold, providing principled extreme-value behavior.
