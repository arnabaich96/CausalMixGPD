---
title: "Workflow 14: Causal Inference: No X (CRP) - Gamma Kernel"
output:
  rmarkdown::html_vignette:
    code_folding: show
vignette: >
  %\\VignetteIndexEntry{Workflow 14: Causal Inference: No X (CRP) - Gamma Kernel}
...
The causal model fits separate outcome distributions for treated and control
arms. Without covariates, the estimands reduce to contrasts between two
unconditional DP mixtures (optionally with GPD tails).
