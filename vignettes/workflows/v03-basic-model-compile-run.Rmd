---
title: "Workflow 3: Basic Workflow: Model Specification, Bundle, & MCMC"
output: 
  rmarkdown::html_vignette:
    code_folding: show
vignette: >
  %\\VignetteIndexEntry{Workflow 3: Basic Workflow: Model Specification, Bundle, & MCMC}
...
The workflow builds a DP mixture model, compiles the NIMBLE code, and then
explores the posterior with MCMC. Posterior draws are used to summarize density,
quantiles, and uncertainty in model parameters.
