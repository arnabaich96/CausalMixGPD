---
title: "2. Available Distributions and Related Functions"
output:
  rmarkdown::html_vignette:
    highlight: null
    code_folding: show
vignette: >
  %\VignetteIndexEntry{2. Available Distributions and Related Functions}
...
## Introduction with GPD kernel {#v02-introduction-with-gpd-kernel}
...
The **CRP backend** uses base (single-kernel) functions, while the **SB backend** uses mixture (multi-component) functions. The â€œTypeâ€ column indicates whether each backend expects **scalar** parameters (single value per parameter) or **vectors** indexed by mixture component.
