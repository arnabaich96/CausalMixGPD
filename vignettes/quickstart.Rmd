...
We show both SB and CRP backends, then show what changes when `GPD = TRUE`.
...
With `GPD = TRUE`, high quantiles typically increase because the tail is modeled
explicitly rather than extrapolated from the bulk mixture.
