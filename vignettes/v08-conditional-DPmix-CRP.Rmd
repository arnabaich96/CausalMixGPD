...
output: 
  rmarkdown::html_vignette:
    code_folding: show
vignette: >
  %\VignetteIndexEntry{8. Conditional DPmix with CRP Backend}
...
```{r diagnostics}
plot(fit_cond_normal, family = c("traceplot", "density"))
plot(fit_cond_amoroso, family = c("traceplot", "density"))
```
