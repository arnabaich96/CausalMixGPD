...
```{r start-viz-concept, fig.cap="DPmixGPD concept: flexible bulk + GPD tail stitched at a threshold."}
...
```{r start-s3-predict, fig.cap="Density prediction on held-out grid (posterior mean)."}
