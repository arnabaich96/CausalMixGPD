...
print("Mean outcome (T=0):", mean(y[T == 0]), "\n")
print("Mean outcome (T=1):", mean(y[T == 1]), "\n")
```
...
print("Causal bundle (CRP + logit PS) created.\n")
```
...
print("Posterior mean treatment effect:", ate_logit, "\n")

print("\nProbit PS Model:\n")
ate_probit <- coef(fit_probit)
print("Posterior mean treatment effect:", ate_probit, "\n")

print("\nNaive Model:\n")
ate_naive <- coef(fit_naive)
print("Posterior mean treatment effect:", ate_naive, "\n")
```
...
print("CATE at X1 = -1, 0, 1 (Logit PS):\n")
print(cate_logit)
```
...
print("  Control PS range: [", min(ps_control), ",", max(ps_control), "]\n")
print("  Treated PS range: [", min(ps_treated), ",", max(ps_treated), "]\n")
```
