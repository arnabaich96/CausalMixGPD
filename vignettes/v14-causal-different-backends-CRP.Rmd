---
title: "14. Causal Inference: Mixed Backends (Bulk-only) - Lognormal Kernel"
output:
  rmarkdown::html_vignette:
    code_folding: show
vignette: >
  %\VignetteIndexEntry{14. Causal Inference: Mixed Backends (Bulk-only) - Lognormal Kernel}
...
# Causal Inference: Mixed Backends (Bulk-only) - Lognormal Kernel {#causal-different-backends-bulk}

This vignette fits two mixed-backend causal models with a shared lognormal kernel:

- Model A: Treated = SB, Control = CRP
- Model B: Treated = CRP, Control = SB

Lognormal requires positive outcomes, so we shift y before modeling.
...
summary_tbl %>%
  ...
  kable(caption = "Shifted Outcome Summary (Lognormal)", align = "c") %>%
...
## Model A: Treated SB, Control CRP (Lognormal)
...
## Model B: Treated CRP, Control SB (Lognormal)
