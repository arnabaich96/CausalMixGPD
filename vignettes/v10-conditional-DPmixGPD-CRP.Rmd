...
output: 
  rmarkdown::html_vignette:
    code_folding: show
vignette: >
  %\VignetteIndexEntry{10. Conditional DPmixGPD with CRP Backend}
...
```{r diagnostics}
plot(fit_cond_gpd_lognormal, family = c("traceplot", "density"))
plot(fit_cond_gpd_normal, family = c("traceplot", "density"))
```
