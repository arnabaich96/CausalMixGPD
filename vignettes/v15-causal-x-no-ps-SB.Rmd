...
pred_p_gpd <- predict(fit_crp_gpd, x = x_eval, y = y_eval, type = "prob", interval = "credible")
head(pred_p_gpd)
plot(pred_p_gpd)
```
...
pred_p_bulk <- predict(fit_sb_bulk, x = x_eval, y = y_eval, type = "prob", interval = "credible")
head(pred_p_bulk)
plot(pred_p_bulk)
```
