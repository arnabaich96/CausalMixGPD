...
```{r diagnostics}
plot(fit_sb_cond_gpd_gamma, params = c("threshold", "tail_shape", "tail_scale"), family = c("caterpillar", "traceplot"))
plot(fit_sb_cond_gpd_gamma, params = "shape", family = "traceplot")
plot(fit_sb_cond_gpd_laplace, params = c("threshold", "tail_shape", "tail_scale"), family = c("caterpillar", "traceplot"))
plot(fit_sb_cond_gpd_laplace, params = "scale", family = "caterpillar")
```
