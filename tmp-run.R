...
bundle_sb_gamma <- build_nimble_bundle(y=y_mixed, kernel='gamma', backend='sb', components=5, GPD=FALSE, mcmc=mcmc)
bundle_sb_cauchy <- build_nimble_bundle(y=y_mixed, kernel='cauchy', backend='sb', components=5, GPD=FALSE, mcmc=mcmc)
