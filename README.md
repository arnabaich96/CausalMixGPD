...
**DPmixGPD** implements Dirichlet process mixture models (CRP or stick-breaking) with an optional generalized Pareto tail and a consistent prediction API.
...
- [**Function reference**](https://arnabaich96.github.io/DPmixGPD/pkgdown/reference/index.html)
